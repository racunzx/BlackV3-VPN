...
import com.tg.ultrasshservice.aidl.IUltraSSHServiceInternal;
...
import com.tg.ultrasshservice.tunnel.TunnelManagerThread;
...
import com.tg.ultrasshservice.util.DummyActivity;

public class TGNETVPNService extends Service
implements SkStatus.StateListener
{
	private static final String TAG = TGNETVPNService.class.getSimpleName();
	public static final String START_SERVICE = "com.tg.net:startTunnel";
	...
	private final IBinder mBinder = new IUltraSSHServiceInternal.Stub() {
        ...
        @Override
        public void stopVPN() {
            TGNETVPNService.this.stopTunnel();
        }
	...
	public void endTunnelService() {
		mHandler.post(new Runnable() {
				...
				public void run() {
					...
					stopSelf();
					SkStatus.removeStateListener(TGNETVPNService.this);
				}
			});
	}
	...
	public static PendingIntent getGraphPendingIntent(Context context) {
        ...
        intent.setComponent(new ComponentName(context, context.getPackageName() + ".TGNETVPNMainActivity"));
	...
	public static final String TUNNEL_SSH_RESTART_SERVICE = TGNETVPNService.class.getName() + "::restartservicebroadcast",
	TUNNEL_SSH_STOP_SERVICE = TGNETVPNService.class.getName() + "::stopservicebroadcast";
