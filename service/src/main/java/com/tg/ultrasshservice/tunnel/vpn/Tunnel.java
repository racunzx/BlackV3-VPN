...
package com.tg.ultrasshservice.tunnel.vpn;
			...
			boolean enabledFilter, boolean filterBypassMode, String[] filterApps, boolean enableTethering) throws java.lang.Exception
	{
		...
		try
		{
			...
			if (Build.VERSION.SDK_INT >= 21) {
				builder.addDisallowedApplication("com.tg.net");
				mHostService.onDiagnosticMessage(String.format("Bypass OK ✔"));
			...
			tunFd = builder
					...
					.setConfigureIntent(TGNETVPNService.getGraphPendingIntent(mHostService.getContext()))
					.establish();
