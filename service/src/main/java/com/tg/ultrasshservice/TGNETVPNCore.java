...
* @author SlipkHunter
*/
public class TGNETVPNCore
{
	private static TGNETVPNCore mInstance = null;
	private Context mContext;
	
	public static void init(Context context) {
		if (mInstance == null) {
			mInstance = new TGNETVPNCore(context);
		}
	}
	
	private TGNETVPNCore(Context context) {
		mContext = context;
    ...
    private void createNotificationChannels() {
        ...
        NotificationChannel mChannel = new NotificationChannel(TGNETVPNService.NOTIFICATION_CHANNEL_BG_ID,
        ...
        mChannel = new NotificationChannel(TGNETVPNService.NOTIFICATION_CHANNEL_NEWSTATUS_ID,
        ...
        mChannel = new NotificationChannel(TGNETVPNService.NOTIFICATION_CHANNEL_USERREQ_ID,
