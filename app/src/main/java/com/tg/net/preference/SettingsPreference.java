		...
		switch (pref.getKey()) {
			...
			case MODO_NOTURNO_KEY:
				...
				mHandler.postDelayed(new Runnable() {
					@Override
					public void run() {
						Context context = TGNETVPNApp.getApp();
