...
import com.tg.net.util.KillThis;
...
import com.tg.ultrasshservice.tunnel.TunnelUtils;
import com.tg.ultrasshservice.util.CustomNativeLoader;
import com.tg.ultrasshservice.logger.SkStatus;

import android.widget.LinearLayout;
import android.os.Build;
import android.app.Activity;
import com.tg.ultrasshservice.logger.ConnectionStatus;
import android.os.Handler;
import androidx.core.content.ContextCompat;
import com.tg.net.fragments.ClearConfigDialogFragment;
...
import com.tg.ultrasshservice.config.ConfigParser;
import androidx.core.app.ActivityCompat;
import android.content.DialogInterface;
import com.tg.ultrasshservice.tunnel.TunnelManagerHelper;
import com.tg.ultrasshservice.LaunchVpn;
...
public class TGNETVPNMainActivity extends BaseActivity
...
{
	private static final String TAG = TGNETVPNMainActivity.class.getSimpleName();
	private static final String UPDATE_VIEWS = "MainUpdate";
	public static final String OPEN_LOGS = "com.tg.net:openLogs";
	...
	private void startTimer() {
		...
		mCountDownTimer = new CountDownTimer(mTimeLeftInMillis, 1000) {
			...
			public void onFinish() {
				...
				Intent reconTunnel = new Intent(TGNETVPNService.TUNNEL_SSH_RESTART_SERVICE);
				LocalBroadcastManager.getInstance(TGNETVPNMainActivity.this).sendBroadcast(reconTunnel);
 ...
 // #####################	
	...
	protected void onCreate(@Nullable Bundle savedInstanceState)
	{
		...
		SharedPreferences prefs = getSharedPreferences(TGNETVPNApp.PREFS_GERAL, Context.MODE_PRIVATE);
	...
	private void doLayout() {
		...
		if (!BuildConfig.DEBUG) {
			//adsBannerView.setAdUnitId(TGNETVPNApp.ADS_UNITID_BANNER_MAIN);
		}
		...
		mButtonSet.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View v) {
					...
					if (input.length() == 0) {
						Toast.makeText((TGNETVPNMainActivity.this), "INSIRA UM TEMPO", Toast.LENGTH_SHORT).show();
					
						return;
					}
					long millisInput = Long.parseLong(input) * 60000;
					if (millisInput == 0) {
						Toast.makeText((TGNETVPNMainActivity.this), "INSIRA UM TEMPO VALIDO", Toast.LENGTH_SHORT).show();
		...
		mButtonStartPause.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View v) {
					if (mTimerRunning) {
						...
						startTimer();
						Toast.makeText(TGNETVPNMainActivity.this, "RECONEXÃO ATIVADA", Toast.LENGTH_SHORT).show();
					}
		...
		ListaServidores.add("Servidor 1 - VIVO");
		ListaServidores.add("Servidor 1 - CLARO 1");
		ListaServidores.add("Servidor 1 - CLARO 2");
		ListaServidores.add("Servidor 1 - CLARO 3");
		ListaServidores.add("Servidor 1 - CLARO 4");
		ListaServidores.add("Servidor 1 - TIM 1");
		ListaServidores.add("Servidor 1 - TIM 2");
		ListaServidores.add("Servidor 1 - TIM 3");
		ListaServidores.add("Servidor 1 - TIM 4");
		ListaServidores.add("Servidor 1 - TIM 5");
		ListaServidores.add("Servidor 1 - TIM 6");
		ListaServidores.add("Servidor 1 - TIM 7");
		ListaServidores.add("Servidor 1 - TIM 8");
			...
			public void onItemSelected(AdapterView<?> p1, View p2, int position, long p4)
			{
				...
				try
				{
                    ...
                    if(position == 0) {
						...
						sPrefs.edit().putString(Settings.SLOW_CHAVE_KEY, "0a6c72901f3d9023b270d7185680a9baad9c0f3212e6505df6f579432673ae6f").apply();
						sPrefs.edit().putString(Settings.SLOW_NAMESERVER_KEY, "s.tgnethg.tk").apply();
						...
						//PAYLOAD
						sPrefs.edit().putString(Settings.CUSTOM_SNI, "web.whatsapp.com").apply();

						//PAYLOAD PRA NAO FICAR VAZIO
						sPrefs.edit().putString(Settings.CUSTOM_PAYLOAD_KEY, "web.whatsapp.com").apply();

						//MODO DE CONEXÃO OPERADORA (SSL SNI)
						sPrefs.edit().putInt(Settings.TUNNELTYPE_KEY, Settings.bTUNNEL_TYPE_SSH_SSL).apply();

						//SERVIDOR
						sPrefs.edit().putString(Settings.SERVIDOR_KEY, "tgnet.servep2p.com").apply();
						...
						//PAYLOAD
						sPrefs.edit().putString(Settings.CUSTOM_SNI, "m.twitter.com").apply();

						//PAYLOAD PRA NAO FICAR VAZIO
						sPrefs.edit().putString(Settings.CUSTOM_PAYLOAD_KEY, "m.twitter.com").apply();
						...
						//PAYLOAD
						sPrefs.edit().putString(Settings.CUSTOM_SNI, "instagram.com").apply();

						//PAYLOAD PRA NAO FICAR VAZIO
						sPrefs.edit().putString(Settings.CUSTOM_PAYLOAD_KEY, "instagram.com").apply();
						...
						//PAYLOAD
						sPrefs.edit().putString(Settings.CUSTOM_PAYLOAD_KEY, "HTTP/[crlf] 200 [crlf]Host: [rotate=m.opera.com;www.xvideos.com;www.tiktok.com;vivo.com;www.dropbox.com;www.voxer.com;www.youtube.com][crlf][crlf]").apply();
						...
						//PAYLOAD
						sPrefs.edit().putString(Settings.CUSTOM_PAYLOAD_KEY, "HTTP/[crlf] 200 [crlf]Host: <li> http:Host: mini5-1.opera-mini.net:80/[crlf]X-Online-Host: mini5-1.opera-mini.net:80/[crlf][crlf][crlf]").apply();
						...
						//PAYLOAD
						sPrefs.edit().putString(Settings.CUSTOM_PAYLOAD_KEY, "HTTP/[crlf] 200 [crlf]Host: <li> http://;www.dropbox.com\" class=\"header__home__url\"><svg width=\"14\" height=\"14\" viewBox=\"0 0 14 14\" xmlns=\"www.voxer.com[lf][crlf][crlf]").apply();
						...
						//PAYLOAD
						sPrefs.edit().putString(Settings.CUSTOM_PAYLOAD_KEY, "POLL HTTP/1.1 Host: https://4z9giyi2c1.execute-api.us-west-2.amazonaws.com\\n").apply();
						...
						//PAYLOAD
						sPrefs.edit().putString(Settings.CUSTOM_PAYLOAD_KEY, "ACL HTTP/2[crlf]Host: plus.google.com[crlf]").apply();
						...
						//PAYLOAD
						sPrefs.edit().putString(Settings.CUSTOM_PAYLOAD_KEY, "SEARCH http://www.waze.com HTTP/1.0[crlf]Host: http://www.waze.com[crlf]Connection: keep-alive[crlf]X-Online-Host: http://www.waze.com[crlf]X-Forward-Host: http://www.waze.com[crlf]X-Forwarded-For: http://www.waze.com[crlf]").apply();
						...
						//PAYLOAD
						sPrefs.edit().putString(Settings.CUSTOM_PAYLOAD_KEY, "ACL HTTP/[crlf]Host: www.waze.com[crlf]").apply();
						...
						//PAYLOAD
						sPrefs.edit().putString(Settings.CUSTOM_PAYLOAD_KEY, "ACL buzzfeed.com HTTP/1.1[lf]Host:buzzfeed.com[lf]").apply();
		...
		//Sistema de usuario e senha na tela inicial by @TGNETVPN
	...
	public void startOrStopTunnel(Activity activity) {
		if (SkStatus.isTunnelActive()) {
			TunnelManagerHelper.stopTGNETVPN(activity);
		}
		else {
			try {
				startdnsvoid();
	...
	private void openlink() {
			String link = "https://www.app-tg-net.online/";
	...
	private void showLogWindow() {
		Intent updateView = new Intent("com.tg.net:openLogs");
		LocalBroadcastManager.getInstance(this)
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		switch (item.getItemId()) {
			...
			/*case R.id.miSobre:
				LayoutInflater li1 = LayoutInflater.from(TGNETVPNMainActivity.this);
				View view = li1.inflate(R.layout.fragment_dialog_licenses, null);
				try
				{
					String licences = Utils.readFromAssets(TGNETVPNMainActivity.this,"LICENSES");
				...
				new AlertDialog.Builder(TGNETVPNMainActivity.this)
						.setTitle("Licenças")
						.setView(view)
						.show();
	...
	public void showExitDialog() {
		...
		dialog.setButton(DialogInterface.BUTTON_POSITIVE, getString(R.
				...
				new DialogInterface.OnClickListener() {
					...
					{
						Utils.exitAll(TGNETVPNMainActivity.this);
					}
				}
		);
